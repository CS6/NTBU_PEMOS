...
const byte NUM_OF_DATA = 1;  
const byte swPins[] = {3, 5, 6, 7, 8, 9};
const byte swBPins[] = {1, 2,10, 11, 12, 13};
const char *swNamesA[] = {"門", "燈", "櫃1", "櫃2", "櫃3", "櫃4"};
const char *swNamesB[] = {"A", "B", "D", "H", "TT", "BN"};
// /mboolean ledState = LOW;        // LED狀態
...
void showPage(WebServer &server) {
 ...
 /// int keystate = digitalRead(Key1Pin); // 取得煙霧輸入PIN 腳的值
  server.println("<body><li><h1 align='center'>數值</h1><div id='lights'><H2 align='center'>");
 ...
 /// server.print("<span class='sw off'>華氏Temperature (oF): </span>");
  ...
  /// server.print("<HR color='#696969' size='10' >");
   ...
   /////////////
 server.println("</head><body><h1 align='center'>開關</h1><div id='lights'><ul><table>");
...
void loop() {
  ...
  File dataFile = SD.open("datalog.txt", FILE_WRITE);
   ...
   dataFile.println(DHT11.getFahrenheit(), 2);
